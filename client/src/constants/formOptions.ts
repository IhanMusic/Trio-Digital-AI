...
export const PRODUCT_CATEGORIES_BY_SECTOR: Record<string, string[]> = {
  ...
  "Beauté et Bien-être": [
    ...
    "Faux-cils et extensions",
    "Pinceaux et accessoires maquillage",
    "Maquillage bio et naturel",
    "Maquillage longue tenue",
    "Démaquillants spécialisés",
    
    // Cosmétiques visage (détaillé)
    "Nettoyants visage",
    "Démaquillants",
    "Toniques et lotions",
    "Sérums anti-âge",
    ...
    "Masques visage",
    "Gommages et exfoliants visage",
    "Protection solaire visage",
    "Soins des lèvres",
    "Soins acné et imperfections",
    "Soins peaux sensibles",
    "Soins homme visage",
    "Cosmétiques bio visage",
    
    // Cosmétiques corps (détaillé)
    ...
    "Soins minceur et fermeté",
    "Déodorants et anti-transpirants",
    "Soins des mains",
    "Soins des pieds",
    "Soins intimes",
    "Cosmétiques bio corps",
    
    // Parapharmacie (détaillé)
    ...
    "Produits solaires médicaux",
    "Anti-âge médical",
    "Soins cicatrisants",
    "Produits anti-chute cheveux",
    ...
    "Produits d'hygiène hospitalière",
    
    // Soins capillaires (détaillé)
    "Shampoings",
